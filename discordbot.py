...
ID_EMOJI = [ 649873366609559562, 660296850309382154, 647089719569678336, 624831147582685184, 624828301743095818]
########################################################################################################################
...
　　for emoji_ID in ID_EMOJI:
        got_emoji = client.get_emoji(emoji_ID)
        if got_emoji:
            await tmp_msg.add_reaction(got_emoji)
