...
ID_ROLE_ADMIN = 666361330827132979  # 飼い主ロールID（事前設定用）
...
ID_EMOJI = [ 666357490337710083, 666357549838106692, 666357419072421908, 666357329838604288, 624828301743095818]
########################################################################################################################
